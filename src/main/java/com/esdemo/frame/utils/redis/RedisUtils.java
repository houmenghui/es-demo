package com.esdemo.frame.utils.redis;
...
public class RedisUtils {
     ...
     * @return 对应的多个键值
     */
    public static <V, T> Map<V, T> hMGet(String key) {
     ...
     */
    public static <V, T> boolean hMSet(String key, Map<V, T> map) {
        try {
     ...
     * @return true成功 false失败
     */
    public static <V, T> boolean hMSet(String key, Map<V, T> map, long time) {
        try {
            redisTemplate.opsForHash().putAll(key, map);
            if (time > 0) {
                expire(key, time);
     ...
     */
    public static <V, T> boolean hSet(String key, V item, T value) {
        try {
     ...
     * @return true 成功 false失败
     */
    public static <V, T> boolean hSet(String key, V item, T value, long time) {
        try {
            redisTemplate.opsForHash().put(key, item, value);
            if (time > 0) {
                expire(key, time);
     ...
     */
    public static <V> boolean hHasKey(String key, V item) {
     ...
     * @return
     */
    public static <V> double hIncr(String key, V item, double by) {
     ...
     * @return
     */
    public static <V> double hDecr(String key, V item, double by) {
        return redisTemplate.opsForHash().increment(key, item, -by);
    }
     ...
     * @return true 存在 false不存在
     */
    public static <T> boolean sHasKey(String key, T value) {
        try {
     ...
     * @return 成功个数
     */
    public static <T> long sSetAndTime(String key, long time, T... values) {
        try {
