...
public final class SwaggerNoteLmc {
    ...
    public static final String QUERY_MACHINE_INFO = "机具管理-机具筛选\n" +
            "- 请求参数\n" +
            "  - select_type: 筛选类型 必填  1-可下发  2-全部 3-可回收，位于请求body中\n" +
            "  - title_type: 标题类型 select_type=2时必填  1-全部机具  2-我的机具，位于请求body中\n" +
            "  - is_all: 全选是否选中 必填  0-未勾中全选  1-勾中全选\n" +
            "  - terminal_id: 筛选终端号， 选填，位于请求body中\n" +
            "  - psam_no: 筛选psam编号，选填，位于请求body中\n" +
            ...
            "  - agentname_no: 筛选代理商编号，选填，位于请求body中，需要提前调用机具筛选的代理商接口查询该代理下的代理商，选择后传对应的代理商编号给后台即可\n" +
            "  - lowerStatus: 筛选代理商是否包含下级 1 是 2否 3仅直属下级\n" +
            "  - hlf_active: 筛选商户激活状态 0未激活 1 已激活\n" +
            "  - sn_min: 选填，位于请求body中\n" +
            "  - sn_max: 选填，位于请求body中\n" +
            ...
            "  - hlf_active 商户激活状态 0未激活 1 已激活\n" +
            "  - model 机具型号\n" +
            "- 返回操作说明\n" +
            "  - 不会下发机具是否解绑状态，解绑状态需要去公共参数接口拿去开关funCode030,当前登入一级代理商只需要判断开关,所有层级都能操作;当前登入二级，需要判断开关和操作的数据是否是直属商户;其他级别的都没有解绑权限\n"+
            "  - 机具详情直接把需要的参数带进详情页即可，不另外提供接口\n";

    public static final String MANAGE_TERMINAL = "机具管理-机具下发/回收操作\n" +
            "- 请求参数\n" +
    ...
    public static final String GET_PUBLIC_DATA = "获取公共数据\n" +
            ...
            "- 返回成功的数据示例\n" +
            "- 返回参数说明\n" +
            "  - showHotLinePhone 是否展示热线电话\n" +
            "  - hotLinePhone 热线电话\n" +
            "  - hotLinePhoneTip 热线电话提示\n"+
            "  - toBeSetListSize 待设置代理商总条数\n"+
            "  - funCode030 代理商解绑权限开关\n"+
            "  - funCode044 代理商进件功能入口\n"+
            "";
    ...
    public static final String QUERY_ACTIVITY_TYPES = "查询当前代理商勾选的欢乐返子类型\n" +
            "- 请求参数\n" +
            "  -无\n" +
            "- 返回成功的数据示例\n" +
            "  - {\n" +
